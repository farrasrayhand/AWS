...
<details>
      ...
      <ul>
        <li> Open another browser tab and go to <a href="https://console.aws.amazon.com/ec2" target=_blank>https://console.aws.amazon.com/ec2</a></li>
        <li> Click <b>Instances</b>.</li>
        Note that an EC2 instance named <i>instance1</i> exists, and that it is in a <i>running</i> state.
        <li> From the <b>Description</b> tab of instance1, copy the <b>instance ID</b> (it will start with <i>i-</i>)</li>
        <b>Note</b>: Leave this browser tab open. You will return to it in a moment.
      </ul>
...
18. In the top-right corner of the **Code source** box, choose <span id="ssb_lambda_orange">Deploy</span>.
